...
create_constraint_mode -name CON\
   -sdc_files\
    [list ${::IMEX::libVar}/mmmc/riscv_top_synth.sdc]
create_analysis_view -name WC_VIEW -constraint_mode CON -delay_corner WC_CORNER
create_analysis_view -name BC_VIEW -constraint_mode CON -delay_corner BC_CORNER
